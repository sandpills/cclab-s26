...
let dancerClasses = [CircleDancer, dancerGhost, daiadancer, Cat, spongeDancer, MindyDancer, myBot, NurbolDancer, TamilaDancer, SavannaDancer, CatDancer, TeddyBearDancer
];
...
function draw() {
    ...
    textSize(20)
    fill(200, 200, 10)
    text("commands: a-add, d-delete, s-smoke, l-lights", 15, 25);
    pop()
    drawDiscoBall();
    drawDancers();
    drawLights();
